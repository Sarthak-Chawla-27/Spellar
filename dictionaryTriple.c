...
const unsigned int N = 17576; //26*26*26=17576
...
unsigned int hash(const char *word)
{
    ...
    if (word[1] == '\0')
    {
        ...
        o = (((int)c - 97) * 26 * 26) + (((int)c - 97) * 26) + ((int)c - 97) + 1;
    ...
    else if (word[2] == '\0')
    {
        ...
        o = (((int)c[0] - 97) * 26 * 26) + (((int)c[1] - 97) * 26) + 1;
    ...
    else
    {
        ...
        o = (((int)c[0] - 97) * 26 * 26) + (((int)c[1] - 97) * 26) + ((int)c[2] - 97) + 1;
